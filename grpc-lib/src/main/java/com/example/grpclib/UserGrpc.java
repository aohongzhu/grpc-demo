...
public class UserGrpc {
  ...
  public static final String SERVICE_NAME = "com.hobe.User";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.grpclib.UserRequest,
      com.example.grpclib.UserResponse> METHOD_GET_USER =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "com.hobe.User", "getUser"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.example.grpclib.UserRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.example.grpclib.UserResponse.getDefaultInstance()));
  ...
  @java.lang.Deprecated public static interface User {
    ...
    /**
     */
    public void getUser(com.example.grpclib.UserRequest request,
        io.grpc.stub.StreamObserver<com.example.grpclib.UserResponse> responseObserver);
  }
  ...
  @java.lang.Deprecated public static interface UserBlockingClient {
    ...
    /**
     */
    public com.example.grpclib.UserResponse getUser(com.example.grpclib.UserRequest request);
  }
  ...
  @java.lang.Deprecated public static interface UserFutureClient {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpclib.UserResponse> getUser(
        com.example.grpclib.UserRequest request);
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER:
          serviceImpl.getUser((com.example.grpclib.UserRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpclib.UserResponse>) responseObserver);
          break;
        default:
  ...
  @java.lang.Deprecated public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          asyncUnaryCall(
            new MethodHandlers<
              com.example.grpclib.UserRequest,
              com.example.grpclib.UserResponse>(
